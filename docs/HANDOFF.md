...
| :---: | :---: | :--- | :--- | :--- | :--- |
| 19 | 2026-09-06 | `task/draggable-overlay-ui` | `feat(ui)` | Minimized pill Layers asset icon separation and top-right stacked toast queue system | Review & merge Phase 2 to dev |
