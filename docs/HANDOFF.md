...
| :---: | :---: | :--- | :--- | :--- | :--- |
| 18 | 2026-09-06 | `task/draggable-overlay-ui` | `fix(overlay)` | Refined unknown page HUD labels (header tag, warning banner, counter) and added Shutterstock media subtabs | Review & merge Phase 2 to dev |
